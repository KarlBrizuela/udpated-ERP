                    ...
                    <form id="purchaseOrderForm" class="form-section">
                        ...
                        <div class="customer-section">
                            <div class="customer-details">
                                ...
                                <div class="form-group">
                                    <label>Vendor:</label>
                                    <input type="text" name="vendor_name" id="formVendorName" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>Vendor Contact Person:</label>
                                    <input type="text" name="vendor_contact_person" id="formVendorContactPerson" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>Vendor Address:</label>
                                    <textarea name="vendor_address" id="formVendorAddress" placeholder=""></textarea>
                                </div>
                            </div>
                            <div class="order-details">
                                ...
                                <div class="form-group">
                                    <label>P.O. No.:</label>
                                    <input type="text" name="po_number" id="formPONumber" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>Terms:</label>
                        ...
                        <table class="form-table" id="itemsTable">
                            ...
                            <tbody id="itemsTableBody">
                                <tr>
                                    <td><input type="number" name="quantity[]" placeholder="" min="0" oninput="calculateRowTotal(this)"></td>
                                    <td><input type="text" name="description[]" placeholder=""></td>
                                    <td><input type="text" name="isbn[]" placeholder=""></td>
                                    <td><input type="number" name="unit_price[]" placeholder="" min="0" step="0.01" oninput="calculateRowTotal(this)"></td>
                                    <td><input type="number" name="total_amount[]" placeholder="" readonly></td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><input type="text" id="grandTotal" readonly style="font-weight: 600; text-align: right;"></td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
