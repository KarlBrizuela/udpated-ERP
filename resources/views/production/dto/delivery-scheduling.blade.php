                            ...
                            <table class="table table-hover fs-14">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('production.dto.delivery-tracking') }}" class="btn btn-sm btn-primary">Track</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>SO-2026-002</td>
                                        ...
                                        <td>
                                            <a href="{{ route('production.dto.delivery-tracking') }}" class="btn btn-sm btn-info">View Status</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>SO-2026-003</td>
                                        ...
                                        <td>
                                            <a href="{{ route('production.logistic.delivery-receipt-list') }}" class="btn btn-sm btn-success">View DR</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
