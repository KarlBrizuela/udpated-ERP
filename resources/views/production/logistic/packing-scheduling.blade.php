<x-app-layout :title="'Packing & Scheduling'" :sidebar="'production'">
    <div class="container-fluid">
        <!-- Packing & Scheduling Overview -->
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-black mb-3">Manage packing operations and schedule deliveries for
                            completed pick lists.</p>
                        <div class="row">
                            ...
                            <table class="table table-hover fs-14">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>-</td>
                                        <td>
                                            <a href="javascript:void(0);" class="btn btn-sm btn-primary">Start
                                                Packing</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>2026-01-22</td>
                                        <td>
                                            <a href="{{ route('production.logistic.delivery-receipt') }}" class="btn btn-sm btn-info">Create
                                                DR</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"
                                                class="btn btn-sm btn-success">Schedule Delivery</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
